...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"package/template.js":[function(require,module,exports) {
"use strict";
...
var template3 = function template3(str) {
  ...
  var fn = new Function("users", "var p = []; p.push('" + _str.replace(/[\r\t\n]/g, "").replace(/<%=(.*?)%>/g, "');p.push($1);p.push('").replace(/<%/g, "');").replace(/%>/g, "p.push('") + "');return p.join('');");
...
var _template = require("./package/template");
...
//# sourceMappingURL=/template.e31bb0bc.js.map